  ...
  return (
    <div className="flex gap-x-24 m-auto items-center">
      ...
      <div className="flex-row space-y-4">
        <div className="font-bold uppercase text-[28px] leading-[32.81px] tracking-wider max-w-xl">{title}</div>
        <div className="font-thin text-[20px] tracking-wide leading-[28.13px] max-w-xl">{content}</div>
      </div>
    </div >
  )
}
